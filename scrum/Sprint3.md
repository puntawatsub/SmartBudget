...
| **Jiya Jameela**       | UI Designer / Full-Stack Developer   | Built the **Dashboard page** styled components for responsiveness and accessibility. Worked on **Upcoming Bill page** ensuring smooth frontend and backend flow. Developed the **Reset Password** page frontend with partial backend integration. Wrote testings for **User Authentication** endpoints and **Goals** endpoints and integrated CSV functionality for data handling .               |
