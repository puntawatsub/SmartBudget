...
const Home = () => {
  ...
  return (
    <div className='flex flex-col min-h-[calc(100vh-64px-80px)] bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100'>
      {/* Hero Section */}
      ...
      {/* Why Choose Us */}
      <section className='text-center my-16 flex-1'>
        ...
        <div className='flex flex-col md:flex-row justify-center gap-6 px-4 md:px-20'>
          {['Budget Tracking', 'Budget Planning', 'Financial Insights'].map(
            (item, idx) => (
              <div
                key={idx}
                className='bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 flex-1 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl'>
      ...
      <section className='my-16 px-4 md:px-20 flex-1'>
        <h2 className='text-3xl md:text-4xl font-semibold text-center mb-16'>
          Revolutionise
        </h2>
        <div className='flex flex-col md:flex-row items-stretch gap-6 md:gap-8'>
          {/* Before Using SmartBudget */}
          <div className='flex-1 bg-gray-900 rounded-2xl p-6 md:p-10 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl'>
          ...
          <div className='flex-1 bg-green-50 rounded-2xl p-6 md:p-10 border-2 border-green-300 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl'>
