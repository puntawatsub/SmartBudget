...
//   return (
//     <div className='p-6 flex flex-col gap-6 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100'>
...
//           {goals.map((goal) => (
//             <div key={goal._id} className='flex-1 min-w-[250px] max-w-[300px]'>
//               <GoalCard data={goal} />
//             </div>
//           ))}
//         </div>
