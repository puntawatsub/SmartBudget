...
const UpcomingBillsCard = () => {
  ...
  return (
    <div className='w-full max-w-[1500px] bg-white dark:bg-gray-800 rounded-[10px] shadow p-4 gap-4 flex flex-col transition-transform duration-300 hover:shadow-lg hover:scale-105 mx-auto'>
      {/* Header */}
