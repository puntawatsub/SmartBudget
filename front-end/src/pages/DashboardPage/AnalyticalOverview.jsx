...
//         Analytical Overview
//       </h2>
//       <div className='w-full max-w-[1410px] bg-white rounded-[10px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-wrap'>
//         {stats.map((stat, i) => (
//           <div
//             key={i}
//             className='flex-1 min-w-[220px] h-40 relative border-r last:border-r-0 border-gray-100 overflow-hidden'>
//             {/* Gradient blur */}
//             <div
