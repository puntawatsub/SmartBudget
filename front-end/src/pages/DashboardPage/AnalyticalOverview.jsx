const AnalyticalOverview = ({ data }) => {
  ...
  return (
    <div className='w-full max-w-[1410px] mx-auto'>
      ...
      <div className='w-full bg-white rounded-[10px] shadow-[0px_1px_2px_0px_rgba(0,0,0,0.05)] outline outline-1 outline-offset-[-1px] outline-gray-200 flex flex-wrap hover:scale-105 hover:shadow-lg transition-transform duration-300'>
        {stats.map((stat, i) => (
          <div
            key={i}
