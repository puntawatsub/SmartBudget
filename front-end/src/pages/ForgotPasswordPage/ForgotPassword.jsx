  ...
  return (
    <div className="flex flex-row h-full overflow-hidden">
      ...
      <div className="flex-1 relative overflow-hidden h-full not-xl:hidden">
        <div className="w-[794px] h-[546px] left-[-149px] bottom-[-272px] absolute bg-[conic-gradient(from_180deg_at_50%_50%,#B9C9DA_0deg,#ECEAED_360deg)] rounded-full blur-[150px]" />
        <div className="w-[854px] h-[591px] left-[-27px] top-[-273px] absolute bg-[conic-gradient(from_180deg_at_50%_50%,#B9C9DA_0deg,#ECEAED_360deg)] rounded-full blur-[150px]" />
